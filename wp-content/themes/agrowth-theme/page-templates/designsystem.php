...
<?php  include( get_template_directory() . '/phtml/components/search/search.phtml');?>
<?php  include( get_template_directory() . '/phtml/components/select/select.phtml');?>
<?php  include( get_template_directory() . '/phtml/components/text-input/text-input.phtml');?>
<?php  include( get_template_directory() . '/phtml/components/text-area/text-area.phtml');?>
<?php  include( get_template_directory() . '/phtml/components/number-input/number-input.phtml');?>
<?php  include( get_template_directory() . '/phtml/components/form/form.phtml');?>
<?php  include( get_template_directory() . '/phtml/components/link/link.phtml');?>
