...
$(document).ready(function(){var e,n={37:1,38:1,39:1,40:1};function o(e){(e=e||window.event).preventDefault&&e.preventDefault(),e.returnValue=!1}function t(e){if(n[e.keyCode])return o(e),!1}$(".navbar-li").click(function(){return window.location=$(this).find("a").attr("href"),!1}),$(".btn--menu").click(function(){$(".bx--navbar--submenu__mobile").toggleClass("visible"),$(".btn--menu").toggleClass("active"),$(".btn--menu").hasClass("active")?(window.addEventListener&&window.addEventListener("DOMMouseScroll",o,!1),window.onwheel=o,window.onmousewheel=document.onmousewheel=o,window.ontouchmove=o,document.onkeydown=t):$(".btn--menu").hasClass("active")||(window.removeEventListener&&window.removeEventListener("DOMMouseScroll",o,!1),window.onmousewheel=document.onmousewheel=null,window.onwheel=null,window.ontouchmove=null,document.onkeydown=null)}),$(".bx--navbar--submenu__close-button").click(function(){$(".bx--navbar--submenu__mobile").removeClass("visible")}),$(document).keydown(function(e){switch(e.which){case 37:resourceSwiper.slideNext();break;case 38:break;case 39:resourceSwiper.slidePrev();break;case 40:case 13:case 27:break;default:return}e.preventDefault()}),e=$(".interactive-icon__icon"),$(e).mouseover(function(){$(this).siblings().addClass("active")}),$(e).mouseout(function(){$(this).siblings().removeClass("active")});var s=$(".bx--navbar"),i=$(".bx--navbar__mobile");if($(window).on("scroll",function(){var e=$(this).scrollTop(),n="0 4px 8px 0 rgba(255, 102, 101,"+e/600/10+")",o="0 8px 16px 0 rgba(0, 0, 0,"+e/600/20+")";if(e<600)s.css({"box-shadow":n+","+o});else{n="0 4px 8px 0 rgba(255, 102, 101, 0.1)",o="0 8px 16px 0 rgba(0, 0, 0, 0.05)";s.css({"box-shadow":n+","+o})}if(e<600)i.css({"box-shadow":n+","+o});else{n="0 4px 8px 0 rgba(255, 102, 101, 0.1)",o="0 8px 16px 0 rgba(0, 0, 0, 0.05)";i.css({"box-shadow":n+","+o})}}),$(".hero").length){var c=$(".hero-image"),a=$(".hero__bg-image"),r=$(".hero-subheading"),l=$(".hero-heading"),u=$(".hero-paragraph");$(window).on("scroll",function(){var e=$(this).scrollTop(),n=$(".hero").offset().top+$(".hero").height(),o=1-e/n;if(!(e<n))return!1;c.css({opacity:o}),a.css({opacity:o}),r.css({opacity:o}),l.css({opacity:o}),u.css({opacity:o})})}$(".card-aboutus-1").length&&($(".card-aboutus-1").addClass("active"),$(".circle-sm-1").addClass("active"),$(".circle-sm").click(function(){$(".circle-sm").removeClass("active"),$(this).addClass("active")}));var d,b=1;setInterval(function(){outer=$(".circle-outer"),middle=$(".circle-middle"),inner=$(".circle-inner"),0<outer.length&&(!0===outer.is(":hover")||!0===middle.is(":hover")||!0===inner.is(":hover")||(b=b%360+1,$(".circle-inner").css("transform","rotate("+b+"deg)"),$(".circle-sm svg").css("transform","rotate(-"+b+"deg)")))},30);function m(e,n){$(".card-aboutus-1").addClass("active"),$(e).click(function(){$(".card-aboutus").removeClass("active"),$(n).addClass("active")})}function v(e){$(e).hover(function(){$(".bx--navbar--submenu").addClass("is-visible")},function(){$(".bx--navbar--submenu").removeClass("is-visible")})}m(".icn-growthanalysis--simple",".card-aboutus-1"),m(".icn-bulb",".card-aboutus-2"),m(".icn-testing",".card-aboutus-3"),m(".icn-measure",".card-aboutus-4"),m(".icn-iterate",".card-aboutus-5"),$(".reading-indicator").length&&(window.onscroll=function(){var e,n,o;e=document.body.scrollTop||document.documentElement.scrollTop,n=document.documentElement.scrollHeight-document.documentElement.clientHeight,o=e/n*100,document.getElementById("readingIndicator").style.width=o+"%"}),$(".sticky-bar").length&&$(window).scroll(function(){var e=$(window).height()/2-150,n=$(".sticky-bar").offset().top-$(window).scrollTop(),o=($(".sticky-bar").offset().top,$(window).height(),$(".sticky-container").offset().top),t=$(".sticky-container").offset().top+$(".sticky-container").height();n<=e&&$(".sticky-bar").addClass("fixed"),$(window).scrollTop()+e<o+264&&$(".sticky-bar").removeClass("fixed"),$(window).scrollTop()+e>t-256&&($(".sticky-bar").addClass("fade"),setTimeout(function(){$(".sticky-bar").addClass("hide")},200)),$(window).scrollTop()+e<=t-256&&($(".sticky-bar").removeClass("hide"),setTimeout(function(){$(".sticky-bar").removeClass("fade")},100))}),$(".navbar--li.submenu").hover(function(){var e=($(this).width()+32)/2+$(this).offset().left;$(".bx--navbar--submenu .snippet").css("left",+e-8)}),v(".navbar--li.submenu"),v(".bx--navbar--submenu .snippet"),v(".bx--navbar--submenu"),$(".navbar--li:nth-child(1)").hover(function(){$(".submenu--container.submenu-2").removeClass("is-visible"),$(".submenu--container.submenu-1").addClass("is-visible")}),$(".navbar--li:nth-child(2)").hover(function(){$(".submenu--container.submenu-1").removeClass("is-visible"),$(".submenu--container.submenu-2").addClass("is-visible")}),d=".our-values--col",$(d).length&&$(d).hover(function(){$(this).toggleClass("hover")}),$("#btn-resume").click(function(){$("#your-resume").click()}),$("#btn-bio").click(function(){$("#your-bio").click()}),function(){if($(".section-content__outer").length){var e=$(".section-content__outer h1, .section-content__outer h2, .section-content__outer h3, .section-content__outer h4, .section-content__outer h5, .section-content__outer h6, .section-content__outer p, .section-content__outer li, .section-content__outer span, .section-content__outer a").text().trim().replace(/[\s]+/g," ").split(" ").length;console.log("Number of words = "+e+" words");var n=$(".section-content__outer img").length;console.log("Number of images = "+n+" images");var o=(e/275*60+10*n)/60;console.log("Exact readtime = "+o+" min");var t=Math.round(o);console.log("Final Readtime = "+t+" min")}}()});
